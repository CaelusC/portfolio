...
const projects = [
  {
    ...
    year: "2024",
    description: "A 2D game built in the Godot engine, currently in active development. My contributions include NPC AI and pathfinding, a game state machine, battle system logic, and custom sprites and animations for all NPCs",
    tags: ["Godot", "C++", "JSON"],
  ...
  },
  {
    ...
    year: "2025",
    description: "A web application built for a school project that simulates a movie rental store like Blockbuster. Users can create accounts and rent movies, while the app manages store inventory and handles rental and return logic. The application is secured with bcrypt password hashing and thoroughly tested using Vitest.",
